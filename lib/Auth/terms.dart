                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Text(
                      ...
                      '1. Introduction\n'
                      'Les présentes Conditions Générales d\'Utilisation (ci-après les "CGU") régissent l\'utilisation de l\'application Ticket to go (ci-après l\'"Application"), '
                      ...
                      'L\'Application décline toute responsabilité quant à la validité, l\'authenticité, la disponibilité ou la légalité des billets vendus via l\'Application. Ticket to go ne '
                      ...
                      'L\'Application est fournie "en l\'état" et sans aucune garantie de quelque nature que ce soit, explicite ou implicite. Ticket to go ne garantit pas que l\'Application sera '
                      ...
                      'Dans toute la mesure permise par la loi, Ticket to go ne pourra être tenue responsable de tout dommage direct ou indirect, matériel ou immatériel, '
                      ...
                      'Les données personnelles collectées via l\'Application sont traitées conformément à la Politique de Confidentialité de Ticket to go accessible à [lien vers la Politique de Confidentialité]. '
                      ...
                      'En cas de litige entre utilisateurs concernant une transaction, ceux-ci s\'engagent à tenter de résoudre leur différend à l\'amiable. Ticket to go ne saurait être tenue responsable '
                      'de tels litiges et n\'intervient pas dans leur résolution.\n\n'
                      '9. Modifications des CGU\n'
                      'Ticket to go se réserve le droit de modifier les présentes CGU à tout moment. Les modifications seront applicables dès leur publication sur l\'Application. '
                      ...
                      'Les présentes CGU sont régies par le droit [indiquez votre juridiction, ex. français]. Tout litige relatif à l\'Application ou à l\'interprétation des CGU sera soumis à la compétence exclusive '
                      'des tribunaux de [indiquez votre lieu de juridiction].\n\n'
                      '11. Contact\n'
                      'Pour toute question relative aux présentes CGU, vous pouvez contacter notre service clientèle à l\'adresse suivante : Contactus.tickettogo@gmail.com.',
                    ),
                  ),
                ),
              ),
